...
var (
	...
	keyPat        = regexp.MustCompile(`\b(sk-or-v1-[a-zA-Z0-9]{64,})\b`)
)
...
func (s Scanner) Description() string {
	return "OpenRouter provides unified access to multiple AI models. API keys can be used to access various LLM providers through a single interface."
}
